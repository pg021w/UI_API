...
1. To run go to TestRunner under Runner and put tag as "@searchProduct"
2. I have used BDD with POM model for Ui automation
3. Note - Sometimes the website is showing captcha which cannot be automated.
...
2. To run got to TestRunner under Runner and put tag as mentioned above
